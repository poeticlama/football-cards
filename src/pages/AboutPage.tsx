  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-200">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
          <h1 className="text-5xl font-bold text-green-700 mb-6">About Football App</h1>

          <div className="prose prose-green">
            <p className="text-xl mb-4">
              <span className="font-bold">Football Statistics</span> — это платформа для отслеживания и анализа статистики игроков.
            </p>
