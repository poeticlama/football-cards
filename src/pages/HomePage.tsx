    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-300">
        <div className="container mx-auto px-4 py-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-10 text-green-700">
            MY PLAYERS
          </h1>
          <Link
            to="new"
            className="rounded-xl bg-green-700 text-xl text-white py-3 px-7 hover:bg-green-800"
          >
            + Add new player
          </Link>
        </div>
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center space-x-3 bg-white rounded-lg shadow-sm px-6 py-3">
            <label
              htmlFor="sort"
              className="text-sm font-medium text-green-700 whitespace-nowrap"
            >
              Sort by:
            </label>
